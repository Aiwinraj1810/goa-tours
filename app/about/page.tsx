    ...
    <CommonContainer>
      <div className="mx-auto max-w-6xl px-4 py-12">
        ...
        <p className="text-muted-foreground max-w-3xl">
          We’re local experts dedicated to authentic, premium experiences across
          Goa. From serene beaches and historic forts to hidden waterfalls and
          culinary trails, our mission is to craft moments that feel both
